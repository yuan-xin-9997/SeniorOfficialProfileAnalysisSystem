    ...
    <div v-if="detail" class="modal" @click.self="detail = null">
      <div class="modal-card profile-detail">
        ...
        <div class="detail-hero">
          ...
          <div><h3>{{ detail.current_position || '职务待补充' }}</h3><p>{{ detail.organization }} · {{ detail.administrative_rank }}</p><span class="pill ok">{{ detail.status }}</span></div>
        </div>
