...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'analysis', component: () => import('@/views/Analysis.vue'), meta: { page: 'analysis', title: '智能分析' } },
      { path: 'analysis-tasks', redirect: '/analysis' },
      { path: 'analysis-result', redirect: '/analysis' },
